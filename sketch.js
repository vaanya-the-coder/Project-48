...
function draw(){
    ...
    if(snake.end()){
        ...
        text("Your score is "+score,w/4,3*h/4);
        appleImg = null;
        bananaImg = null;
        strawberryImg = null;
        orangeImg = null;
    ...
    if(rand === 1){
        image(appleImg,food.x,food.y,3,3);
    }
    else if(rand === 2){
        image(bananaImg,food.x,food.y,3,3);
    }
    else if(rand === 3){
        image(grapesImg,food.x,food.y,3,3);
    }
    else if(rand === 4){
        image(orangeImg,food.x,food.y,3,3);
    }
    else if(rand === 5){
        image(strawberryImg,food.x,food.y,3,3);
    }
